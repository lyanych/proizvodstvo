const additives = [
    { name: 'Спирт (плодовый или зерновой)', image: 'Добавки/спирт.png' },
...
const processes = [
    ...
    { name: 'Центрифуга', image: 'Процессы/центрифуга.png' },
...
const stages = {
    ...
    'Белое вино': {
        ...
        'Ферментация (Брожение)': { 
            src: 'Итог/Виноград/шампанское.png', 
            caption: 'Шампанское', 
            next: 'Шампанское'
        },
...
'Дистиллят': {
    ...
    'Восстановленный сок сахарного тростника': {
     ...
     'Дистиллят Ромовый белый С/Х': {
        ...
        'Розлив': { 
            src: 'Итог/Сахарный_тростник/белый_ром_сх.png', 
    ...
    'Фильтрованный настой на можжевельнике': {
        ...
        'Розлив': { 
            src: 'Итог/Спирт/джин_кл.png', 
            caption: 'Джин классический', 
            next: 'Джин классический'
        },

        'Дистилляция (перегонка)': { 
            src: 'Итог/Спирт/джин_сух.png', 
            caption: 'Джин лондонский сухой', 
            next: 'Джин лондонский сухой'
        },
        initial: {
            src: 'Итог/Спирт/настой_можж_фильтр.png',
            caption: 'Фильтрованный настой на можжевельнике'
